...
```{r}
mutate(first_pcr, sampleday = ifelse(Sample_pre == 37 | Sample_pre == 38, "day26", ifelse(Sample_pre == 30 | Sample_pre == 31 | Sample_pre == 32 | Sample_pre == 33 | Sample_pre == 34, "day01", "unknown")))
```
